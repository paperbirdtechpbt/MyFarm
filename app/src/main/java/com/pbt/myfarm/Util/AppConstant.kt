...
class AppConstant {
    companion object {
        ...
        const val COL_tasks_PRIMARYKEY = "tasks_primarykey"
        const val COL_tasks_SERVERid = "tasks_serverid"
        const val COL_tasks_NAME = "tasks_name"
        const val COL_tasks_DESC = "tasks_descp"
        const val COL_tasks_GROUP = "tasks_comgroup"
        const val COL_tasks_TASK_CONFIGID = "tasks_task_configid"
        const val COL_tasks_TASKFUNC = "tasks_taskfun"
        ...
        const val COL_tasks_LASTCHANGED_DATE = "tasks_last_change_date"
        const val COL_tasks_DELTED_AT = "tasks_deleted_At"
        ...
        const val COL_task_fields_SERVERID = "task_fields_id"
        const val COL_task_fields_TASKID = "task_fields_task_id"
        const val COL_task_fields_FIELDID = "task_fields_fieldid"
        ...
        const val COL_people_PRIMARYKEY = "people_Primary"
        const val COL_people_SERVERID = "people_Serverid"
        ...
        const val COL_people_BIRTHPLACE = "people_birth_place"
        ...
        const val COL_people_DEWSCIPTION = "people_description"
        ...
        const val COL_container_PRIMARYKEY = "container_Primary"
        const val COL_container_SERVERID = "container_servid"
        const val COL_container_NAME = "container_name"
        const val COL_container_DESCIPTION = "container_description"
